...
# Google Maps API Key
GOOGLE_MAPS_API_KEY = 'AIzaSyA7A4meMvKdqnjXpZ0WKzJB-P6oUtIlvgs'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-#0d^1z598)xxq@cx=d82190%2vh$$@@1bthad@1h)nadzllv15'
...
LOGIN_REDIRECT_URL = 'sale_list'  # Redirect to home (/)
LOGOUT_REDIRECT_URL = 'login'  # Optional: redirect after logout
LOGIN_URL = '/login/'

# Email settings for password reset
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
# ********** Email settings for password reset w/ LIVE SMTP etc **********
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'C:/Users/marzs/salesapp/debug.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
